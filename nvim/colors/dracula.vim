...
let s:palette           = {}
let s:palette.fg        = ['#F8F8F2', 253]

let s:palette.bglighter = ['#424450', 238]
let s:palette.bglight   = ['#343746', 237]
let s:palette.bg        = ['#282A36', 236]
let s:palette.bgdark    = ['#21222C', 235]
let s:palette.bgdarker  = ['#191A21', 234]

let s:palette.comment   = ['#6272A4',  61]
let s:palette.selection = ['#44475A', 239]
let s:palette.subtle    = ['#424450', 238]

let s:palette.cyan      = ['#8BE9FD', 117]
let s:palette.green     = ['#50FA7B',  84]
let s:palette.orange    = ['#FFB86C', 215]
let s:palette.pink      = ['#FF79C6', 212]
let s:palette.purple    = ['#BD93F9', 141]
let s:palette.red       = ['#FF5555', 203]
let s:palette.yellow    = ['#F1FA8C', 228]

"
" ANSI
"
let s:palette.color_0  = '#21222C'
let s:palette.color_1  = '#FF5555'
let s:palette.color_2  = '#50FA7B'
let s:palette.color_3  = '#F1FA8C'
let s:palette.color_4  = '#BD93F9'
let s:palette.color_5  = '#FF79C6'
let s:palette.color_6  = '#8BE9FD'
let s:palette.color_7  = '#F8F8F2'
let s:palette.color_8  = '#6272A4'
let s:palette.color_9  = '#FF6E6E'
let s:palette.color_10 = '#69FF94'
let s:palette.color_11 = '#FFFFA5'
let s:palette.color_12 = '#D6ACFF'
let s:palette.color_13 = '#FF92DF'
let s:palette.color_14 = '#A4FFFF'
let s:palette.color_15 = '#FFFFFF'
...
call s:h('DraculaCommentBold', s:comment, s:none, [s:attrs.bold, s:attrs.bold])
